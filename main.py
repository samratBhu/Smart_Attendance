...
class AttendanceApp:
    def __init__(self, root):
        self.root = root
        self.root.title("FAMS - Face Recognition Based Attendance Management System")
        self.root.geometry('800x500')
        self.root.configure(background='black') 

        self.title_label = tk.Label(root, text="Attendance System", font=("Helvetica", 24), bg='black', fg='white')  
        self.title_label.pack(pady=20)

        self.start_button = tk.Button(root, text="Start Attendance", command=self.start_attendance, font=("Helvetica", 14), bg='#4caf50', fg='white') 
        self.start_button.pack(pady=10)

        self.stop_button = tk.Button(root, text="Stop Attendance", command=self.stop_attendance, state=tk.DISABLED, font=("Helvetica", 14), bg='#f44336', fg='white')  
